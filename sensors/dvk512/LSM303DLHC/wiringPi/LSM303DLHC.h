...
#define  LSM303DLHC_FS_1_3_GA               ((unsigned char) 0x20)  /*!< Full scale = ±1.3 Gauss */
#define  LSM303DLHC_FS_1_9_GA               ((unsigned char) 0x40)  /*!< Full scale = ±1.9 Gauss */
#define  LSM303DLHC_FS_2_5_GA               ((unsigned char) 0x60)  /*!< Full scale = ±2.5 Gauss */
#define  LSM303DLHC_FS_4_0_GA               ((unsigned char) 0x80)  /*!< Full scale = ±4.0 Gauss */
#define  LSM303DLHC_FS_4_7_GA               ((unsigned char) 0xA0)  /*!< Full scale = ±4.7 Gauss */
#define  LSM303DLHC_FS_5_6_GA               ((unsigned char) 0xC0)  /*!< Full scale = ±5.6 Gauss */
#define  LSM303DLHC_FS_8_1_GA               ((unsigned char) 0xE0)  /*!< Full scale = ±8.1 Gauss */
...
#define LSM303DLHC_FULLSCALE_2G            ((unsigned char)0x00)  /*!< ±2 g */
#define LSM303DLHC_FULLSCALE_4G            ((unsigned char)0x10)  /*!< ±4 g */
#define LSM303DLHC_FULLSCALE_8G            ((unsigned char)0x20)  /*!< ±8 g */
#define LSM303DLHC_FULLSCALE_16G           ((unsigned char)0x30)  /*!< ±16 g */
